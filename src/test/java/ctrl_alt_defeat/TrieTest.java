...
public class TrieTest {
  ...
  public void splittingTest() {
    ...
    assertTrue(trie.getRoot().getChildren().get('a').getChildren()
        .containsKey('$'));
    assertTrue(trie.getRoot().getChildren().get('a').getChildren()
        .containsKey('b'));
    assertTrue(trie.getRoot().getChildren().get('a').getChildren().get('$')
        .terminal());
    assertTrue(!trie.getRoot().getChildren().get('a').getChildren().get('b')
        .terminal());
    assertTrue(trie.getRoot().getChildren().get('a').getChildren().get('b')
        .getChildren().containsKey('$'));
    assertTrue(trie.getRoot().getChildren().get('a').getChildren().get('b')
        .getChildren().containsKey('c'));
    assertTrue(trie.getRoot().getChildren().get('a').getChildren().get('b')
        .getChildren().containsKey('d'));
  ...
  public void trieFunctions() {
    ...
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 0)
        .contains(StringFormatter.listify("@test$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 1).size() == 4);
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 1)
        .contains(StringFormatter.listify("@test$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 1)
        .contains(StringFormatter.listify("@best$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 1)
        .contains(StringFormatter.listify("@fest$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 2).size() == 7);
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 2)
        .contains(StringFormatter.listify("@test$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 2)
        .contains(StringFormatter.listify("@best$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 2)
        .contains(StringFormatter.listify("@fest$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 2)
        .contains(StringFormatter.listify("@bet$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 2)
        .contains(StringFormatter.listify("@tester$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 2)
        .contains(StringFormatter.listify("@tested$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 3).size() == 13);
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 3)
        .contains(StringFormatter.listify("@test$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 3)
        .contains(StringFormatter.listify("@best$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 3)
    ...
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 3)
        .contains(StringFormatter.listify("@tested$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 3)
        .contains(StringFormatter.listify("@brat$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 3)
        .contains(StringFormatter.listify("@bets$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 3)
        .contains(StringFormatter.listify("@testing$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 3)
        .contains(StringFormatter.listify("@first$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 3)
        .contains(StringFormatter.listify("@fiesta$")));
    assertTrue(trie.editDistance(StringFormatter.listify("@test$"), 3)
        .contains(StringFormatter.listify("@flat$")));
    ...
    assertTrue(trie.whitespace(StringFormatter.listify("@testingtesting$"))
        .size() == 1);

    assertTrue(trie.evaluateWord(StringFormatter.listify("@test$"), null)
        .size() == 1);
    assertTrue(trie.evaluateWord(StringFormatter.listify("@tes$"), null).size() == 0);
    assertTrue(trie.evaluateWord(StringFormatter.listify("@oogabooga$"), null)
        .size() == 0);

    trie.prefixOn();
    assertTrue(trie.evaluateWord(StringFormatter.listify("@testing$"), null)
        .size() == 1);
    assertTrue(trie.evaluateWord(StringFormatter.listify("@test$"), null)
        .size() == 4);
    ...
    // test for whitespace operator, also checks that the weighting is properly
    // done
    trie.whiteSpaceOn();
    assertTrue(trie.evaluateWord(StringFormatter.listify("@betstest$"), null)
        .size() == 2);
  ...
  public void nodeFunctionTest() {
    ...
    assertTrue(n.getChildren().get('c').getSequence()
        .equals(StringFormatter.listify("cdefg")));
    assertTrue(n.getChildren().get('d').getSequence()
        .equals(StringFormatter.listify("de")));
    ...
    assertTrue(n.getChildren().get('c').getSequence()
        .equals(StringFormatter.listify("cdefg")));
    assertTrue(n.getChildren().get('d').getSequence()
        .equals(StringFormatter.listify("d")));
    assertTrue(n.getChildren().get('d').getChildren().get('e').getSequence()
        .equals(StringFormatter.listify("e")));
    assertTrue(n.getChildren().get('d').getChildren().get('f').getSequence()
        .equals(StringFormatter.listify("f")));
    ...
    assertTrue(n.getChildren().get('c').fullList()
        .equals(StringFormatter.listify("abcdefg")));
    assertTrue(n.getChildren().get('d').getChildren().get('e').fullList()
        .equals(StringFormatter.listify("abde")));
    assertTrue(n.getChildren().get('d').getChildren().get('f').fullList()
        .equals(StringFormatter.listify("abdf")));
  }
}
