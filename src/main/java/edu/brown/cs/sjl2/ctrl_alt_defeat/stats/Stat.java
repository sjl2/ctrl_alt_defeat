...
public interface Stat {
  ...
  /**The method which executes the stat on the current GameStats object.
   * Will be called once on the player who got the stat and once on the
   * his/her team's stats.
   *
