...
public class StatFactory {
  ...
  private static final List<String> TYPES = Arrays.asList("Assist", "Block",
      "DefensiveFoul", "FreeThrow", "MissedFreeThrow", "MissedTwoPointer",
      "MissedThreePointer", "OffensiveFoul", "OffensiveRebound",
      "DefensiveRebound", "Steal", "TechnicalFoul", "ThreePointer", "Turnover",
      "TwoPointer");
   ...
   * @return the stat
   */
  public Stat addStat(String statType, Player p,
